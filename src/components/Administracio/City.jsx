...
<div className="row d-flex mx-0 bg-secondary mt-3 rounded-top">
            ...
            {({ errors, touched, isSubmitting }) => (
              <Form>
                ...
                <div className="mb-3">
                  ...
                  {errors.province_id && touched.province_id && <div className="text-danger">{errors.province_id}</div>}
                </div>
                <Button variant="primary" type="submit" disabled={isSubmitting}>Crear</Button>
              </Form>
            )}
          </Formik>
        </Modal.Body>
      ...
      <Modal show={showView} onHide={() => setShowView(false)}>
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={() => setShowView(false)}>Tancar</Button>
        </Modal.Footer>
      </Modal>
            ...
            >
              {({ errors, touched, isSubmitting }) => (
                <Form>
                  ...
                  <Button variant="primary" type="submit" disabled={isSubmitting}>Actualitzar</Button>
                </Form>
              )}
            </Formik>
          )}
